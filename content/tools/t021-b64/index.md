...
description = "在线直达地址: 以v2ex帖子留言解密(decode)为例 原帖子地址: 解密地址: 直接在网络论坛留下自己的 邮箱/手机号/qq号/微信号 并不安全, 使用base64可以对敏感进行一定的保护, 但base64和二维码类似,只是人眼不可读, 使用解密程序,可以轻松解析真实的信息, 所以base64"
weight = 979
date = "2020-01-21"
categories = ["在线工具"]
tags = ["在线工具", "效率工具"]
aliases = ["/T021-b64.md", "/T021-b64/", "/docs/T021-b64.md"]
+++
...
![2020-06-13-base64-decode](./index.assets/2020-06-13-base64-decode.gif)
...
![2020-06-13-base64-encode](./index.assets/2020-06-13-base64-encode.gif)
...
![tiancai](./index.assets/tiancai.jpg)
