...
description = "直达链接: 我最近在给自己的公众号分栏目, 恰好可以用里面的文字来给公众号logo生成文字云 输入文字 图中绿色标注的Size参数有些特别: 如果词组(比如 谷粒 )只使用一次,Size可以精确控制词组的尺寸, 但由于我们的词组需要填充满整个图像来形成文字云, 谷粒 这个词就需要被多次用到,如果 谷"
weight = 996
date = "2020-01-04"
categories = ["在线工具"]
tags = ["在线工具", "效率工具"]
aliases = ["/T004-word-art.md", "/T004-word-art/", "/docs/T004-word-art.md"]
+++
...
![](./index.assets/73520366-6b796380-443e-11ea-80d8-49a9fb2848fb.png)

## 输入文字

![image](./index.assets/73532153-14cc5380-4457-11ea-9306-019956d4c17b.png)
...
![](./index.assets/73535630-f9654680-445e-11ea-8337-3409ea512f79.png)

![](./index.assets/73535907-a8098700-445f-11ea-94f2-5d5ce89bbb74.gif)
...
![](./index.assets/73536246-7e9d2b00-4460-11ea-8053-993185ce0f35.png)
...
![](./index.assets/73537219-ebb1c000-4462-11ea-88d5-ea919824e816.png)
...
![](./index.assets/73539905-7e555d80-4469-11ea-9be6-6e636ab4cd8e.png)
