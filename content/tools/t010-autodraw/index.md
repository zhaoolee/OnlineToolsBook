...
description = "在线直达地址: 实力画渣, 在线画鱼(智能识图工具) 再画个鱼钩钓鱼(演示自由变换工具) 给鱼钩和鱼上个色(演示上色工具) 给画作配文字(演示文字工具) 画鱼点睛(演示填充工具) 稍微多整几条鱼(按住option/alt拖拽图像可以快速复制) 导出大作 导出的图片非常高清(实力画渣, 在线丢人) 本"
weight = 990
date = "2020-01-10"
categories = ["在线工具"]
tags = ["在线工具", "效率工具"]
aliases = ["/T010-autodraw.md", "/T010-autodraw/", "/docs/T010-autodraw.md"]
+++
...
![](./index.assets/fish.gif)

## 再画个鱼钩钓鱼(演示自由变换工具)

![](./index.assets/gou.gif)


## 给鱼钩和鱼上个色(演示上色工具)


![](./index.assets/change-color.gif)



## 给画作配文字(演示文字工具)

![](./index.assets/jgdy.gif)


## 画鱼点睛(演示填充工具)


![](./index.assets/eye.gif)


## 稍微多整几条鱼(按住option/alt拖拽图像可以快速复制)

![](./index.assets/option.gif)
...
![](./index.assets/autodraw-fish.png)
