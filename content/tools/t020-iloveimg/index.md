...
description = "在线直达地址： cn/compress image I Love Img提供了在线批量压缩图片的免费服务, 它会自动根据图片特征自动选择压缩参数, 为图片减肥的同时,又不损失画质，是真正的傻瓜级应用。 使用方法非常简单 同时上传 GIF, JPG, PNG三种格式的图片做示范 压缩的结果: 三张图片"
weight = 980
date = "2020-01-20"
categories = ["在线工具"]
tags = ["在线工具", "效率工具"]
aliases = ["/T020-iloveimg.md", "/T020-iloveimg/", "/docs/T020-iloveimg.md"]
+++
...
![image-20201021181156178](./index.assets/image-20201021181156178.png)


<video id="video" controls="" preload="none" poster="./index.assets/image-20201021181156178.png">
<source id="mp4" src="./index.assets/c.mp4" type="video/mp4">
</video>
