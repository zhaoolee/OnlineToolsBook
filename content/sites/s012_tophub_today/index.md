...
description = "当前的信息流网站,推崇「千人千面」的推送 千人千面 推送的优点是 让用户看自己想看的 , 让用户处于自己的舒适区, 用户会刷抖音几十分钟,刷今日头条几十分钟, 以 千人千面 的方式提升用户粘性,对信息提供平台是有好处的; 但用户会刷到大量类似的新闻,浪费用户大量的宝贵时间 其实用户需要的是3分钟能了"
weight = 988
date = "2020-06-12"
categories = ["宝藏网站"]
tags = ["宝藏网站", "资源网站"]
aliases = ["/S012_tophub_today.md", "/S012_tophub_today/", "/docs/S012_tophub_today.md"]
+++
